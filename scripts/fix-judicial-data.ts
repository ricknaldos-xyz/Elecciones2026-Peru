    ...
    penal_sentences: [
      {
        ...
        source: 'poder_judicial',
        status: 'sobreseido',
        sentence: 'Lavado de activos - Caso Odebrecht/Cócteles (aportes campaña 2011/2016). Sobreseído enero 2026 por TC.',
        case_number: 'Exp. 00299-2017 (Caso Cócteles-Odebrecht)',
        date: '2026-01-15',
        citation: 'Poder Judicial, TC Sentencia 185/2025. También: CNN, Ojo Público, France 24, LP Derecho, Legis.pe.',
      },
      {
        ...
        source: 'poder_judicial',
        status: 'sobreseido',
        sentence: 'Organización criminal - Caso Odebrecht/Cócteles. Sobreseído enero 2026 por TC.',
        case_number: 'Exp. 00299-2017 (Caso Cócteles-Odebrecht, cargo org. criminal)',
        date: '2026-01-15',
        citation: 'Poder Judicial, TC Sentencia 185/2025.',
      },
      {
        ...
        source: 'poder_judicial',
        status: 'proceso',
        sentence: 'Falsedad genérica y falsa declaración ante ONPE - Caso Cócteles. Cargo remanente tras sobreseimiento.',
        case_number: 'Exp. 00299-2017 (Cargo remanente)',
        date: '2026-01-15',
        citation: 'Poder Judicial.',
      },
      {
        type: 'lavado_activos',
        court: 'Ministerio Público',
        source: 'poder_judicial',
        status: 'investigacion',
        sentence: 'Lavado de activos - Aportes ilícitos campaña 2021 (Caso Lavamoto). Investigación preparatoria formalizada sep 2025.',
        case_number: 'Caso Lavamoto - Inv. Prep. 2025',
        date: '2025-09-01',
        citation: 'Ministerio Público, RPP.',
      },
    ],
    civil_sentences: [],
  },
    ...
    penal_sentences: [
      {
        ...
        source: 'poder_judicial',
        status: 'proceso',
        sentence: 'Lavado de activos en Caso Odebrecht/OAS. Presuntamente recibió USD 120,000-129,000 de OAS por asesoría a Susana Villarán. En juicio oral.',
        case_number: 'Caso Odebrecht - Villarán (Nieto Montesinos)',
        date: '2019-01-01',
        citation: 'El Comercio, RPP, Infobae. Cobertura mediática en contexto del Caso Odebrecht.',
      },
    ],
    civil_sentences: [],
  },
